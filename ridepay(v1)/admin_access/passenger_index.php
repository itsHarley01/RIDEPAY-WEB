...
<header>
        <a class="btn_m" href="../admin_access/homepage.php">Back to HomePage</a>
...
if(mysqli_num_rows($result) == 0) {
    ...
    while($row=mysqli_fetch_array($result)) {
        ...
        echo "<td> <a class='btnedit' href='../admin_access/Edit/passenger_edit_form.php? passenger_id=$passengerid'>EDIT</a>  
        <a class='btndelete' href='../admin_access/Form/acc_stat.php? passenger_id=$passengerid'>STATUS</a>  
        <a class='btnqr' href='../admin_access/Edit/generate.php? passenger_id=$passengerid'>QR CODE</a></td></tr>";
