...
<h1>
    ...
    <a class ='btn_m' href="../admin_access/Form/addbus_form.php">ADD NEW BUS</a>
    </header>
...
if(mysqli_num_rows($result)== 0) {
    echo "<tr><td colspan=3> NO RECORDS FOUND. Insert record into database </td></tr>";
} else {
    while($row=mysqli_fetch_array($result)) {
        ...
        echo "<td>$driverid</td>";
        echo "<td>$capacity</td>";
        echo "<td> <a class='btnedit' href='../admin_access/Edit/bus_edit_form.php? bus_id=$busid'>EDIT</a></tr>";
    }
}
echo "</table>";
?>
