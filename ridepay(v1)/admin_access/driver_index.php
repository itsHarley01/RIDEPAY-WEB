...
<body>
    ...
    <header>
        ...
        <a class='btn_m' href="../admin_access/Form/adddriver_form.php">ADD NEW DRIVER</a>
    </header>
...
if(mysqli_num_rows($result) == 0) {
    ...
    while($row=mysqli_fetch_array($result)) {
        ...
        echo "<td>$license</td>";
        echo "<td>$connum</td>";
        echo "<td> <a class='btnedit' href='../admin_access/Edit/driver_edit_form.php? driver_id=$driverid'>EDIT</a></td></tr>";
        }
    }
    echo "</table>";
?>
