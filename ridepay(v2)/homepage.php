        ...
        <div id="sidebar">
            <center>
                <div class="taassb">
                    ...
                    <p style="margin-top: 0px; color: white;">Status: <b>admin</b></p>
                </div>
            </center>
            <hr>
            <ul>
                ...
                <li class="itemssb">
                    ...
                    <a class="side" data-page="./admin/passenger_index">Passengers</a>
                </li>
                <li class="itemssb">
                    <i class="fa-solid fa-bus" style="color: #ffffff;"></i>
                    <a class="side" data-page="./admin/bus_index">Bus</a>
                </li>
                <li class="itemssb">
                    <i class="fa-solid fa-user-tie" style="color: #ffffff;"></i>
                    <a class="side" data-page="./admin/driver_index">Driver</a>
                </li>
