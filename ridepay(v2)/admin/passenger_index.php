...
<br>
<a href="../forms/addpassenger.php" class="addsome"><i class="fa-solid fa-user-plus" style="color: #f2be22;"></i> Add Passenger</a>
<?php
...
if (mysqli_num_rows($result) == 0) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo "<td> <a class='btnedit hover-indicator' data-tooltip='Edit' href='../forms/editpass_form.php?passenger_id=$passengerid'><i class='fa-regular fa-pen-to-square' style='color: #f2be22;'></i></a>
        <a class='btndelete hover-indicator' data-tooltip='Delete' href='?delete_passenger_id=$passengerid'><i class='fa-regular fa-trash-can' style='color: #f2be22;'></i></a> 
 <a class='btndelete hover-indicator' data-tooltip='Status' href='../forms/acc_stat.php? passenger_id=$passengerid'><i class='fa-solid fa-circle-info' style='color: #f2be22;'></i></a>  
                <a class='btnqr hover-indicator' data-tooltip='View Qr' href='../forms/generate.php?passenger_id=$passengerid'><i class='fa-solid fa-qrcode' style='color: #f2be22;'></i></a></td></tr>";
    }
}
